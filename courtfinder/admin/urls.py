...
urlpatterns = [
    ...
    url(r'^local_authorities', views.LocalAuthoritiesList.as_view(), name='local_authorities'),
    ...
    url(r'^edit_local_authority/$', views.EditAOL.as_view(), name='edit_local_authority'),
    url(r'^edit_local_authority/(?P<id>[0-9]+)$', views.EditLocalAuthority.as_view(), name='edit_local_authority'),
